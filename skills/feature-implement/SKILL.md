...
Before committing, review the change this stage introduced. Run all of these lenses; fix what you find via `Edit` in the same stage. Every lens but **Supersession / orphans** looks only at the new diff — that one deliberately reaches outside it, at code the stage may have stranded:
